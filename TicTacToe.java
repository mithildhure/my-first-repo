...
public class TicTacToe
{
	...
	private static boolean hasPlayerWon(char[][] board, char symbol )
	{
		if((board[0][0] == symbol && board[0][1] == symbol && board[0][2] == symbol) ||
			...
			(board[0][1] == symbol && board[1][1] == symbol && board[2][0] == symbol) )	
			{
				return true;
			}
		return false;
	...
	private static boolean isValidMove(char [][] board, String position)
	{
		...
		{
			case "1":
			return(board[0][0] == ' ');		//return bhi if else jaisa work krta idk how
			case "2":
	...
	{	
		...
		while(true) 
		{
		System.out.println("Where would u like to play (1-9)?");
